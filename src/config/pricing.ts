...
export function calculatePrice(b: Brief) {
 const items = [
  ['Projeto base', lookup(siteTypes,b.websiteType)], ['Estrutura e páginas',(pagePrices[b.pages] || 0) + Math.max(0,b.pageList.length - 3) * 280], ['Direção de design', (b.design === 'Premium' || b.design === 'Futurista' ? 900 : 0) + (templatePrices[b.template] || 0)],
